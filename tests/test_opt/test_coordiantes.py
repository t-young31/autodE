...
from autode.opt.coordinates.cartesian import CartesianCoordinates3D, cartesian_coordinates
...
def tmp():
    ...
    def test_cartesian_coordinates():
        ...
        assert 0.19 < CartesianCoordinates3D(arr).to('nm')[3] < 0.21
    ...
    def test_grad_transform_linear():
        ...
        x = CartesianCoordinates3D(coords)
